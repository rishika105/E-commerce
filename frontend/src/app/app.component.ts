...
import { heroCamera, heroCheckBadge, heroComputerDesktop, heroCurrencyDollar,
  ...
  heroUserCircle, heroHeart, heroShoppingCart, heroMagnifyingGlass, heroEllipsisVertical, heroPlus} from '@ng-icons/heroicons/outline';
...
@Component({
  ...
  viewProviders: [provideIcons({ heroUsers, heroPhone, heroEnvelope, heroCurrencyDollar, heroHome,
    ...
    heroSwatch, heroCamera, heroDeviceTablet, heroUserCircle, heroHeart, heroShoppingCart, heroMagnifyingGlass, heroEllipsisVertical , heroPlus})]   //ICONS NAME WE HAVE DOWNLOADED HERO ICONS PACKAGE FOR OUR PROJECT
