...
@Component({
  ...
  viewProviders: [provideIcons({ heroUsers, heroPhone, heroEnvelope, heroCurrencyDollar, heroHome,
    ...
    heroSwatch, heroCamera, heroDeviceTablet, heroUserCircle, heroHeart, heroShoppingCart, heroMagnifyingGlass })]   //ICONS NAME WE HAVE DOWNLOADED HERO ICONS PACKAGE FOR OUR PROJECT
